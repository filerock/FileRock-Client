...
class SliderDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.checkbox_3 = wx.CheckBox(self.panel_1, -1, _(""))
...
#        self.Bind(wx.EVT_BUTTON, self.OnSkip, self.skip_button)
        ...
        self.active_panel = 0
        self.skip_button.SetLabel("&Skip")
    ...
    def __do_layout(self):
        ...
        if sys.platform.startswith('win') or FORCE_WIN:
            folder = u'./data/images/slides/'
        elif sys.platform.startswith('darwin') or FORCE_OSX:
            folder = u'./data/images/slides_osx/'
        else:
            folder = u'./data/images/slides/'
        images = map(lambda filename: os.path.join(folder, filename), ["FileRock - Intro.001.png",
