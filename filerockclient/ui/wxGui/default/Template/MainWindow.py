...
class MainWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.folder_bitmap_button = wx.BitmapButton(self, -1, wx.Bitmap("./data/images/folder-48.png", wx.BITMAP_TYPE_ANY))
        self.folder_label = wx.StaticText(self, -1, "Open Folder")
        self.status_bitmap_button = wx.BitmapButton(self, -1, wx.Bitmap("./data/images/dialog-information-48.png", wx.BITMAP_TYPE_ANY))
        self.status_label = wx.StaticText(self, -1, "Status")
        self.activity_bitmap_button = wx.BitmapButton(self, -1, wx.Bitmap("./data/images/applications-system-48.png", wx.BITMAP_TYPE_ANY))
        self.activity_label = wx.StaticText(self, -1, "Activity")
        self.preferences_bitmap_button = wx.BitmapButton(self, -1, wx.Bitmap("./data/images/preferences-system-48.png", wx.BITMAP_TYPE_ANY), style=wx.BU_AUTODRAW)
        self.preferences_label = wx.StaticText(self, -1, "Options")
        self.start_stop_bitmap_button = wx.BitmapButton(self, -1, wx.Bitmap("./data/images/pause-48.png", wx.BITMAP_TYPE_ANY))
        self.start_stop_label = wx.StaticText(self, -1, "Pause")
        self.logs_bitmap_button = wx.BitmapButton(self, -1, wx.Bitmap("./data/images/logs-48.png", wx.BITMAP_TYPE_ANY), style=wx.BU_AUTODRAW)
