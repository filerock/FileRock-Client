...
class PlatformSettingsOSX(PlatformSpecificSettingsBase):
    ...
    def set_autostart(self, enable):
        self.logger.debug("set_autostart() method not implemented")


    def is_systray_icon_whitelisted(self):
        self.logger.debug("is_systray_icon_whitelisted() method not implemented")
        return True

    def whitelist_tray_icon(self):
        self.logger.debug("whitelist_tray_icon() method not implemented")